  ...
  const experiences = [
    {
      ...
      location: 'Remote',
      description: 'Completed a comprehensive 1-month full-stack web development internship program, building a professional portfolio website.',
      achievements: [
        'Built a complete full-stack portfolio website using MERN stack',
        'Implemented contact form with MongoDB database integration',
  ...
  const handleDownloadPDF = () => {
    ...
    printWindow.document.write(`
      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          body { font-family: Arial, sans-serif; padding: 40px; color: #333; line-height: 1.5; max-width: 800px; margin: 0 auto; }
          .header { text-align: center; margin-bottom: 30px; border-bottom: 2px solid #667eea; padding-bottom: 20px; }
          .header h1 { font-size: 28px; margin-bottom: 5px; }
          .header h2 { font-size: 18px; color: #667eea; margin-bottom: 15px; }
          .contact { font-size: 11px; color: #666; margin: 3px 0; }
          .section { margin-bottom: 25px; }
          .section-title { font-size: 16px; color: #667eea; border-bottom: 1px solid #e0e0e0; padding-bottom: 5px; margin-bottom: 12px; }
          .item { margin-bottom: 15px; }
          .item-header { display: flex; justify-content: space-between; margin-bottom: 4px; }
          .item-title { font-size: 14px; font-weight: bold; }
          .item-date { font-size: 11px; color: #667eea; }
          .item-subtitle { font-size: 12px; color: #666; margin-bottom: 5px; }
          .item-description { font-size: 11px; color: #555; margin-bottom: 5px; }
          ul { margin: 5px 0 0 20px; }
          li { font-size: 11px; margin: 2px 0; }
          .skill-category { margin-bottom: 8px; }
          .skill-category strong { font-size: 12px; min-width: 80px; display: inline-block; }
          .footer { margin-top: 30px; text-align: center; font-size: 10px; color: #999; border-top: 1px solid #e0e0e0; padding-top: 10px; }
      ...
      <body>
        ...
        <div class="footer">Resume generated on ${dateStr}</div>
      </body>
      </html>
    `);
